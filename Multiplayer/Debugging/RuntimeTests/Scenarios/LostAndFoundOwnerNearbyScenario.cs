...
internal sealed class LostAndFoundOwnerNearbyScenario :
    IRuntimeTestScenarioDefinition
{
    ...
    public RuntimeTestDescriptorDto Descriptor => LostAndFoundScenarioDescriptors.Create(
        "scenario.lost-and-found-owner-nearby-protection",
        "Nearby owner protects a dropped personal item");
    public IEnumerator Execute(RuntimeTestCommandDto command, RuntimeTestRunDto run) =>
        driver.OwnerNearbyProtection(command, run);
}
#endif
